...
// TestCase class
//
class Test_share_memory_persist : public CPPUNIT_NS::TestCase {
    CPPUNIT_TEST_SUITE(Test_share_memory_persist);
#if 0
    CPPUNIT_IGNORE;
#endif
    CPPUNIT_TEST(test);
...
CPPUNIT_TEST_SUITE_REGISTRATION(Test_share_memory_persist);
...
void Test_share_memory_persist::test() {
