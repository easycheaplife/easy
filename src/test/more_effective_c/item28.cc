...
public:
	...
	_Tp& operator* () const { return *value_; }
...
public:
	...
	void show_value() { std::cout << value_ <<std::endl; }
private:
	int	value_;
};
...
{
public:
	operator auto_ptr<MusicProduct> () { return auto_ptr<MusicProduct>(value_); }
private:
	Cassette* value_;
};
