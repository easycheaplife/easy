...
void TestAllocator::spin_lock_mine()
{
...
void TestAllocator::spin_lock_critical_section()
{
	easy::mutex_lock	__lock;
	for (int __i = 0; __i < MAX_REPEAT_COUNT; ++__i)
	{
