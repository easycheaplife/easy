...
namespace easy
{
	...
	public:
		...
		TYPE operator++ (void) { return ++this->value_; };

		// Atomically post-increment @c value_.
		TYPE operator++ (int) { return this->value_++; }

		// Atomically increment @c value_ by rhs.
		TYPE operator+= (arg_type rhs) { return this->value_ += rhs; }
		...
		easy_bool operator== (arg_type rhs) const {  return this->value_ == rhs; }

		// Atomically compare @c value_ with rhs.
		bool operator!= (arg_type rhs) const {  return this->value_ != rhs; }
		...
		TYPE value (void) const { return this->value_; }
	...
	public:
		...
		// Atomically pre-increment @c value_.
		easy_long operator++ (void) { return ++this->impl_; }

		// Atomically post-increment @c value_.
		easy_long operator++ (int) { return this->impl_++;}

		// Atomically increment @c value_ by rhs.
		easy_long operator+= (long rhs) { return this->impl_ += rhs; }
		...
		// Atomically compare @c value_ with rhs.
		easy_bool operator== (easy_long rhs) const { return this->impl_ == rhs; }
		...
		// Explicitly return @c value_.
		TYPE value (void) const { return this->impl_.value(); }

		// Dump the state of an object.
		void dump (void) const { return this->impl_.dump(); }
	   ...
	   * lock.  Use with care ;-)
	   */
		TYPE & value_i (void) { return this->impl_.value_i (); }
